...
// 调用 state.loading = false
// 热更新  耗时的  DOM更新
// 什么时候快递到了， 热更新已经完成了
nextTick(() => {      // 组件挂载了，且数据绑定模板 已到位
...
window.addEventListener('scroll', _.throttle(setHeaderScroll, 100))  // _.throttle 节流
})
</script>
...
.home-header
  ...
  .header-search
      ...
      // 标准盒模型  设置宽高时 指的是内容，   要加上padding和border， 才是盒子的大小
      // box-sizing: border-box   IE盒模型    宽高就是盒子大小
      height 0.53333rem
      line-height 00.53333rem
      margin 0.26667rem 0
      padding 0.1333rem 0
      color #232326
